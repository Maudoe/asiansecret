...
# perder el plato. Se probó una versión con fondo desenfocado para no
# recortar tanto, pero no gustó el efecto -se sentía como una foto de mala
# calidad-, así que quedó el recorte directo de siempre.
